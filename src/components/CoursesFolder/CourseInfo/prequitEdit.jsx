...
//   console.log(editPrerequisites, prerequisites);
//   useEffect(() => {
//     if (isOpen) {
...
//     try {
//       await onSave(editPrerequisites);
//       onCancel();
//     } catch (error) {
...
//         course: 19,
//       };
//       setEditPrerequisites([...editPrerequisites, newPrerequisiteObj]);
//       setNewPrerequisite("");
//     }
//   };
...
//     console.log(index, "this is waht i was sending to aspi");
...
//           </h2>
//           <ul className="mb-6">
//             {editPrerequisites.map((prerequisite, index) => (
//               <li
//                 key={prerequisite.id}
