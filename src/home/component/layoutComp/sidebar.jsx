...
const Sidebar = ({ isActive }) => {
  ...
  return (
    <aside className="fixed top-14 pt-1 left-0 h-[calc(100vh-3.5rem)] mb-24 bg-white dark:bg-blackTheme text-black dark:text-white min-w-[220px] flex flex-col max-[900px]:hidden lg:flex transition-all duration-75 z-40 max-w-[220px] w-[250px] overflow-y-auto">
      <div className="myMenu flex flex-col justify-center mb-4 mt-2">
        <Link
          to="/dashboard/progress"
          className={`flex h-10 w-full justify-center items-center hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-300 ${
            isActive("/dashboard/progress")
      ...
      <div className="myMenu flex flex-col justify-center mb-4 mt-2">
        <div className="title w-full pl-8 mb-2">
          <h4
            className="uppercase my-1 text-lg font-bold"
            style={{ fontFamily: "Nunito" }}
          >
            Catalog
          </h4>
