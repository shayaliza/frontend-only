...
// function Content() {
//   return (
//     <div className="px-4 coding flex flex-col md:flex-row ">
//       {/* Left Content */}
...
//       </div>
//       {/* Right Content */}
//       <div className="right-content  bg-gray-200 p-4 w-full sm:w-full md:w-1/2 h-full sm:h-full">
//         <iframe
//           id="compiler"
//           frameBorder="0"
//           height="450px"
...
WHERE name = 'John Doe';`}</code>
      ...
      {/* Right Content */}
      <div className="right-content bg-gray-200 p-4 w-full sm:w-full md:w-1/2 h-full sm:h-full sticky top-16">
        <iframe
          id="compiler"
          frameBorder="0"
          height="450px"
