...
function Header() {
  ...
  return (
    <>
      <div className={`fixed  top-0 left-0 w-full h-28 bg-background z-10 text-gray-700 dark:text-gray-300 ${theme == 'dark' ? "bg-black" : "bg-white"}  shadow-lg py-2 px-4 border-b border-gray-400`}>
    ...
    <div
      className={`fixed right-0 h-full z-50 w-4/5 bg-white gap-4 bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-right-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-right-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg ${isInsideProfileOpen ? "translate-x-0" : "translate-x-full"}`}  
    >
