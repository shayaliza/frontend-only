...
function Header() {
  ...
  return (
    <>
      <div className={`fixed top-0 left-0 w-full h-28 bg-background z-10  shadow-lg py-2 px-4 border-b border-gray-600`}>
        <div className="flex justify-between items-center mb-2.5">
          <div className="flex items-center space-x-3">
            <img
              src={profile}
              alt="Profile"
              className="w-10 h-10 rounded-full border-2 shadow-lg cursor-pointer"
      ...
      {isProfileOpen && (
        ...
        <div
          className={`fixed right-0 h-full z-40 w-4/5 gap-4 bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-right-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-right-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg ${isProfileOpen ? "translate-x-0" : "translate-x-full"}`}  
        >
          <div className="p-6">
    ...
    <div
      className={`fixed right-0 h-full z-50 w-4/5 gap-4 bg-background shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-right-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-right-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg ${isInsideProfileOpen ? "translate-x-0" : "translate-x-full"}`}  
    >
  ...
  <div className="fixed inset-0 z-50">
    <div
      className={`fixed right-0 flex flex-col h-full z-50 w-4/5 bg-background shadow-lg transition-transform duration-200 border border-gray-600 ${
