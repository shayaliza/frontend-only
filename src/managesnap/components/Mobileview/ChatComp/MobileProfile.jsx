...
function MobileProfile({ closeMenu }) {
  ...
  return (
    <div>
      <div className="px-3 py-6">
        <button
          onClick={closeMenu}
          className="absolute right-2 top-2 hover:text-red-500 transition-colors"
        >
          <X className="w-5 h-5" />
        </button>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-medium">Saketh</span>
        ...
        {currentView !== "main" && currentView !== "status" && (
          <button onClick={goBack} className="flex items-center space-x-2 mt-4">
      ...
      {currentView === "profile" && (
        <InsideProfile setCurrentView={setCurrentView} />
      )}

      {currentView === "organisation" && (
        <MobileOrg setPreviousView={setPreviousView} />
      )}
