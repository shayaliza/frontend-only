    ...
    <div className={`flex h-[calc(100vh-56px)] ${theme == "dark" ? "bg-black" : "" }`}>
      <div className="flex flex-col w-full h-full">
          ...
          {messages.map((message) => (
            ...
            className={`relative group py-2 px-4 rounded-t-2xl max-w-[40%] ${
              message.user === currentUser.name
                ? "ml-auto rounded-bl-2xl bg-fuchsia-500 text-black dark:bg-gray-500"
                : "mr-auto rounded-br-2xl bg-white text-black dark:bg-gray-700"
            }`}
          >          
              {isChannelChat && (
          ...
          <div className="flex flex-col w-full py-2 overflow-hidden">
            <div className="flex justify-between items-start w-full overflow-y-auto">
              ...
              <button
                ...
                className="relative right-2 top-1/3 w-6 h-6 rounded-full flex-shrink-0 flex justify-center items-center border border-gray-200 hover:bg-red-600 hover:text-white"
              >
        ...
        <div className="message-input px-4 py-4">
          <div className="flex items-center space-x-2 border rounded-lg pr-2 shadow-lg bg-gray-200 dark:bg-black mb-2">
            <textarea
              id="message-textarea"
              value={messageInput}
